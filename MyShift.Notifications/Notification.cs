...
namespace MyShift.Notifications
{
    public class Notification
    {
        ...
        public async Task NotificationFunction([QueueTrigger("test3", Connection = "AzureWebJobsStorage")] string myQueueItem, Microsoft.Extensions.Logging.ILogger log)
        {
            ...
            var Respose = await _serviceEngine.GetDataToNotifiy();
              _serviceEngine.SendDataToQueue(Respose);
        }
    }
}
